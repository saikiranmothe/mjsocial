...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { fb_link: @user_profile.fb_link, image: @user_profile.image, last_name: @user_profile.last_name, name: @user_profile.name, website: @user_profile.website }
    end
  ...
  test "should update user_profile" do
    put :update, id: @user_profile, user_profile: { fb_link: @user_profile.fb_link, image: @user_profile.image, last_name: @user_profile.last_name, name: @user_profile.name, website: @user_profile.website }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
